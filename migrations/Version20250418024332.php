 ...
 */
final class Version20250418024332 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE poll (id INT NOT NULL, chat_id INT DEFAULT NULL, question VARCHAR(255) NOT NULL, is_closed TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_84BCFA451A9A7125 (chat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
