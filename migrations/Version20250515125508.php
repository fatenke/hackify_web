 ...
 */
final class Version20250515125508 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE projets ADD CONSTRAINT FK_B454C1DB996D90CF FOREIGN KEY (hackathon_id) REFERENCES hackathon (id)
        SQL);
        $this->addSql(<<<'SQL'
