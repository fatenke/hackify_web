 ...
 */
final class Version20250416141410 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE participation CHANGE id_participation id_participation INT AUTO_INCREMENT NOT NULL, CHANGE id_participant id_participant INT NOT NULL, CHANGE statut statut VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE projets CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE technologie_id id_hackathon INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE participation CHANGE id_participation id_participation INT NOT NULL, CHANGE id_participant id_participant INT DEFAULT NULL, CHANGE statut statut VARCHAR(20) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE participation ADD CONSTRAINT participation_ibfk_1 FOREIGN KEY (id_hackathon) REFERENCES hackathon (id_hackathon) ON DELETE CASCADE
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE projets CHANGE id id INT NOT NULL, CHANGE id_hackathon technologie_id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
