 ...
 */
final class Version20250415165158 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE participation (id_participation INT AUTO_INCREMENT NOT NULL, id_hackathon INT DEFAULT NULL, id_participant INT NOT NULL, date_inscription DATETIME NOT NULL, statut VARCHAR(255) NOT NULL, INDEX IDX_AB55E24FB0F4A68 (id_hackathon), PRIMARY KEY(id_participation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE projets (id INT NOT NULL, technologie_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, statut VARCHAR(255) NOT NULL, priorite VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, ressource VARCHAR(255) NOT NULL, INDEX IDX_B454C1DB261A27D2 (technologie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE user (id_user INT NOT NULL, nom_user VARCHAR(255) NOT NULL, email_user VARCHAR(255) NOT NULL, role_user VARCHAR(255) NOT NULL, tel_user INT NOT NULL, mdp_user VARCHAR(255) NOT NULL, adresse_user VARCHAR(255) NOT NULL, photo_user VARCHAR(255) NOT NULL, status_user VARCHAR(20) NOT NULL, PRIMARY KEY(id_user)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
