...
class GenerateEntitiesCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        foreach ($tables as $table) {
            ...
            $io->success("Generated: src/Entity/" . ucfirst($table->getName()) . ".php and src/Repository/" . ucfirst($table->getName()) . "Repository.php");
        }
    ...
    private function generateRepository(Table $table): void
    {
        ...
        $filePath = __DIR__ . "/../../src/Repository/{$className}Repository.php";
        if (!file_exists(dirname($filePath))) {
            mkdir(dirname($filePath), 0777, true);
        }
        file_put_contents($filePath, $repositoryCode);
    }
    ...
    private function getPrimaryKeyColumns(string $tableName): array
    {
        ...
        return $indexes['primary'] ? $indexes['primary']->getColumns() : [];
    }
